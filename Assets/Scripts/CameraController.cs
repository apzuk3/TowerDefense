...
public class CameraController : Singleton<CameraController>
{
    ...
    [Range(10f, 20.0f), Tooltip("The most a player can zoom in to the game world.")]
    public float ZoomMax;

    [Range(.5f, 15.0f), Tooltip("The furthest point a player can zoom back from the game world.")]
